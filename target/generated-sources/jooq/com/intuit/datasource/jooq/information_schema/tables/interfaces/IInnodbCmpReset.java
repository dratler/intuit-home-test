...
public interface IInnodbCmpReset extends Serializable {
	...
	/**
	 * Load data from another generated Record/POJO implementing the common interface IInnodbCmpReset
	 */
	public void from(com.intuit.datasource.jooq.information_schema.tables.interfaces.IInnodbCmpReset from);

	/**
	 * Copy data into another generated Record/POJO implementing the common interface IInnodbCmpReset
	 */
	public <E extends com.intuit.datasource.jooq.information_schema.tables.interfaces.IInnodbCmpReset> E into(E into);
}
