...
import com.intuit.datasource.jooq.information_schema.tables.interfaces.IInnodbBufferPageLru;
...
public class InnodbBufferPageLruRecord extends TableRecordImpl<InnodbBufferPageLruRecord> implements Record20<ULong, ULong, ULong, ULong, String, ULong, ULong, String, ULong, ULong, ULong, String, String, ULong, ULong, ULong, String, String, String, ULong>, IInnodbBufferPageLru {

	private static final long serialVersionUID = 2120338392;
	 ...
	 */
	@Override
	public void from(IInnodbBufferPageLru from) {
		setPoolId(from.getPoolId());
		setLruPosition(from.getLruPosition());
		setSpace(from.getSpace());
		setPageNumber(from.getPageNumber());
		setPageType(from.getPageType());
		setFlushType(from.getFlushType());
		setFixCount(from.getFixCount());
		setIsHashed(from.getIsHashed());
		setNewestModification(from.getNewestModification());
		setOldestModification(from.getOldestModification());
		setAccessTime(from.getAccessTime());
		setTableName(from.getTableName());
		setIndexName(from.getIndexName());
		setNumberRecords(from.getNumberRecords());
		setDataSize(from.getDataSize());
		setCompressedSize(from.getCompressedSize());
		setCompressed(from.getCompressed());
		setIoFix(from.getIoFix());
		setIsOld(from.getIsOld());
		setFreePageClock(from.getFreePageClock());
	}
	 ...
	 */
	@Override
	public <E extends IInnodbBufferPageLru> E into(E into) {
		into.from(this);
		return into;
	}
