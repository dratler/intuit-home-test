...
public interface ITablePrivileges extends Serializable {
	...
	/**
	 * Load data from another generated Record/POJO implementing the common interface ITablePrivileges
	 */
	public void from(com.intuit.datasource.jooq.information_schema.tables.interfaces.ITablePrivileges from);

	/**
	 * Copy data into another generated Record/POJO implementing the common interface ITablePrivileges
	 */
	public <E extends com.intuit.datasource.jooq.information_schema.tables.interfaces.ITablePrivileges> E into(E into);
}
