...
import com.intuit.datasource.jooq.information_schema.tables.interfaces.IInnodbCmpmem;
...
public class InnodbCmpmemRecord extends TableRecordImpl<InnodbCmpmemRecord> implements Record6<Integer, Integer, Integer, Integer, Long, Integer>, IInnodbCmpmem {

	private static final long serialVersionUID = 1561228692;
	 ...
	 */
	@Override
	public void from(IInnodbCmpmem from) {
	 ...
	 */
	@Override
	public <E extends IInnodbCmpmem> E into(E into) {
		into.from(this);
		return into;
	}
