...
import com.intuit.datasource.jooq.information_schema.tables.interfaces.IInnodbCmp;
...
public class InnodbCmpRecord extends TableRecordImpl<InnodbCmpRecord> implements Record6<Integer, Integer, Integer, Integer, Integer, Integer>, IInnodbCmp {

	private static final long serialVersionUID = -189050375;
	 ...
	 */
	@Override
	public void from(IInnodbCmp from) {
	 ...
	 */
	@Override
	public <E extends IInnodbCmp> E into(E into) {
		into.from(this);
		return into;
	}
