...
import com.intuit.datasource.jooq.information_schema.tables.interfaces.IInnodbCmpPerIndexReset;
...
public class InnodbCmpPerIndexResetRecord extends TableRecordImpl<InnodbCmpPerIndexResetRecord> implements Record8<String, String, String, Integer, Integer, Integer, Integer, Integer>, IInnodbCmpPerIndexReset {

	private static final long serialVersionUID = 1227964729;
	 ...
	 */
	@Override
	public void from(IInnodbCmpPerIndexReset from) {
	 ...
	 */
	@Override
	public <E extends IInnodbCmpPerIndexReset> E into(E into) {
		into.from(this);
		return into;
	}
